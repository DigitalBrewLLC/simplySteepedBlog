---
heroImage: /src/assets/images/beginner-guide.png
category: Tea Guides
...
Fun fact: all tea comes from the same plant, Camellia Sinensis. Teas are categorized based on processing and oxidation levels. Oxidation refers to how the tea leaves are allowed to interact with oxygen, impacting their color and taste. Tea is categorized into five primary types: black, green, white, oolong, and herbal. Each category offers a unique sensory experience, flavor profile, and appearance when properly brewed.
...
Continue the journey into the world of tea with us on [Instagram](https://www.instagram.com/p/C1h8xV1uFTL/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA== 'Insta blog post')
